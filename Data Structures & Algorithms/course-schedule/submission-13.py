class Solution:
    def canFinish(self, numCourses: int, prerequisites: List[List[int]]) -> bool:
        ...
        # if we visit a node with state=1 -> cycle detected
        # steps:
        # 1. create graph list and populate with empty list the same # as numCourses
        # 2. populate prereq -> course
        # 3. create state list len of numCourses with initial 0s
        # 4. create dfs function
        # 5. for loop and run dfs function
        # 6. set up return
        ...
        # 1. create graph list and populate with empty list the same # as numCourses
        # 2. populate prereq -> course
        # 3. calculate in-degree (# of prereqs per course)
        # 4. Strt BFS form courses with no prerequisite
        # 5. Process courses, reducing indegree of dependents
